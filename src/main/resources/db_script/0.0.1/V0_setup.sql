...
alter sequence hibernate_sequence owner to adolescent_dev_program_prod_owner;
...
alter table revinfo
    owner to adolescent_dev_program_prod_owner;
...
alter table project_project_coordinator
    owner to adolescent_dev_program_prod_owner;
...
alter table project_project_coordinator_aud
    owner to adolescent_dev_program_prod_owner;

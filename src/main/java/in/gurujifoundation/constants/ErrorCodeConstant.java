...
public interface ErrorCodeConstant {
    ...
    String TEACHER_CREATED_SUCCESSFULLY = "Teacher created successfully";
    String TEACHER_UPDATED_SUCCESSFULLY = "Teacher updated successfully";
    ...
    String STUDENT_UPDATED_SUCCESSFULLY = "Student updated successfully";
